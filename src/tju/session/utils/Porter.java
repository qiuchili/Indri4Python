...
public String stemSentence(String sentence){
	String[] terms = this.splitString(sentence);
	String newSentence = "";
	for(String term:terms){
		newSentence += this.stripAffixes(term)+"\n";
	}
...
public static void main(String[] args){
	String indriPath = "D:\\privates\\LJF\\test\\1.dv";
	String porterPath = "D:\\privates\\LJF\\test\\3.txt";
	Map<String,String> map = MapUtil.extractMapStrStr(indriPath,2,0," ");
	HashSet<String> set = FileUtilities.readTextFileAsSet(porterPath);
	HashSet<String> interaction = ToolUtil.getSetIntersection(set,map.keySet());
	System.out.println(map.keySet().size()+"\t"+set.size()+"\t"+interaction.size());
